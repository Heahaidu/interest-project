    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtFilter jwtFilter) throws Exception {
        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/user/auth/secure/profile").permitAll()
                        .requestMatchers("/api/v1/user/auth/register").permitAll()
                        .requestMatchers("/api/v1/user/auth/verify").permitAll()
                        .requestMatchers("/api/v1/user/auth/forgot-password").permitAll()
                        .requestMatchers("/api/v1/user/auth/verify-forgot-password").permitAll()
                        .requestMatchers("/api/v1/user/auth/reset-password").permitAll()
                        .requestMatchers("/api/v1/user/auth/change-password").permitAll()
                        .requestMatchers("/api/v1/user/auth/update-info").permitAll()
                        .requestMatchers("/api/v1/user/auth/delete").permitAll()
